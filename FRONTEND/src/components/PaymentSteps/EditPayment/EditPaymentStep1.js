...
const AddPaymentStep1 = ({ click }) => {
  ...
  const getPayment = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/paymentbyid/${id}`
    );
    ...
    setStudentData({
      ...
      timepayment: response.data.timepayment,
  ...
  const updatePayment = async (e) => {
    if (paymentmethodd === "") {
      ...
      if (
        studentData.firstpayed > paymentdata.balance ||
            ...
            <div className="body-sectionn">
              <div className="mt-3">
                <div className="flex flex-row ">
                  ...
                  <div className="ml-4 font-bold text-xl uppercase">
                    {studentData && studentData.forenamesg}{" "}
                    {studentData && studentData.surnameg}
                  </div>
                </div>
                  ...
                  {invoicedata && invoicedata.courselist.length > 0 && (
                    <p>
                      ...
                      <span className="ml-3 mt-1 text-md ">
                        {invoicedata &&
                          invoicedata.courselist.length > 0 &&
                          invoicedata.courselist.laduration + " "}
                        Months of English
                        {invoicedata &&
                          invoicedata.courselist.length > 1 &&
                          " + " + invoicedata.courselist[1].lecoursename}
                      </span>
                    </p>
                  )}
                  <p>
                    ...
                    <span className="ml-3 mt-1 text-md lowercase">
                      {invoicedata &&
                        invoicedata.purchaselist.length > 0 &&
                        invoicedata.purchaselist
              ...
              <form onSubmit={click}>
                <table className="table-bordered">
                  ...
                  <tbody>
                    {invoicedata &&
                      invoicedata.registration.length >= 0 &&
                      invoicedata.registration.map((regis, index) => (
                    ...
                    {invoicedata &&
                      invoicedata.courselist.length >= 0 &&
                      invoicedata.courselist.map((course, index) => (
                        <tr key={index * (Math.random() * 3)}>
                          <td>1</td>
                    ...
                    {invoicedata &&
                      invoicedata.examlist.length >= 0 &&
                      invoicedata.examlist.map((exam, index) => (
                        <tr key={index * (Math.random() * 3)}>
                          <td>1</td>
                    ...
                    {invoicedata &&
                      invoicedata.purchaselist.length >= 0 &&
                      invoicedata.purchaselist.map((pur, index) => (
                        <tr key={index * (Math.random() * 3)}>
                    ...
                    {invoicedata &&
                      invoicedata.accolist.length >= 0 &&
                      invoicedata.accolist.map((acco, index) => (
                        <tr key={index * (Math.random() * 3)}>
                          <td>{acco.acotimes}</td>
                    ...
                    {invoicedata &&
                      invoicedata.otherlist.length >= 0 &&
                      invoicedata.otherlist.map((other, index) => (
                        <tr key={index * (Math.random() * 3)}>
                          <td>1</td>
                    ...
                    <tr>
                      ...
                      <td className="font-bold">
                        {" "}
                        {invoicedata && invoicedata.currency.lecurrency}{" "}
                        {invoicedata && separator(invoicedata.subtotal)}
                      </td>
                    </tr>
                    <tr>
                      <td colspan="3" className="text-right">
                    ...
                    <tr>
                      ...
                      <td className="font-bold">
                        ...
                        {invoicedata && invoicedata.currency.lecurrency}{" "}
                        {paymentdata &&
                          separator(paymentdata.total && paymentdata.total)}
                      </td>
                    </tr>
                    {paymentdata &&
                    ...
                    <tr>
                      ...
                      <td className="font-bold">
                        {" "}
                        {invoicedata && invoicedata.currency.lecurrency}{" "}
                        {paymentdata && separator(paymentdata.balance)}
                      </td>
                    </tr>
