      ...
      <View style={{ width: "70%" }}>
        ...
        >
          ...
          <Text style={{ marginLeft: 5, fontSize: 8 }}>
            {studentData &&
              studentData.courseList.length >= 1 &&
              studentData.courseList[0].laduration}{" "}
            Months of Eglish
            {studentData &&
              studentData.courseList.length > 1 &&
              " + " + studentData.courseList[1].lecoursename}
          </Text>
        </View>
        <View
          style={{ paddingLeft: 5, flexDirection: "row", marginLeft: "15%" }}
        >
          ...
          <Text style={{ marginLeft: 5, fontSize: 8 }}>
            {studentData &&
              studentData.purchaseList.length > 0 &&
              studentData.purchaseList
        ...
        >
          ...
          <Text style={{ marginLeft: 5, fontSize: 8 }}>
            {studentData &&
              studentData.accoList.length > 0 &&
              studentData.accoList
