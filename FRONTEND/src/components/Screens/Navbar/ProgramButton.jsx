...
const ProgramButton = () => {
  ...
  return (
    <div className="group inline-block text-light-dark text-10">
      <button className="outline-offset-2outline-1  px-3 py-1 bg-dark-purple rounded-sm flex items-center w-auto">
      ...
      <ul className="bg-white border rounded-sm transform scale-0 group-hover:scale-100 absolute transition duration-150 ease-in-out origin-top min-w-32">
        <NavLink to="/students">
          <a>
            <li className="rounded-sm px-3  py-1  pl-6 cursor-pointer">
              Students
            </li>
          </a>
        </NavLink>
