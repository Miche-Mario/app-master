...
const MaintenanceButton = () => {
  ...
  return (
    <div className="group inline-block text-light-dark ml-2 text-10">
      ...
      >
        <span className="pr-1 font-semibold flex-1 text-white">Maintenance</span>
        <span>
          <svg
      ...
      >
        <li className="rounded-sm px-3 py-1 hover:bg-gray pl-6 cursor-pointer">Backup</li>
        <NavLink to="/logs">
            <a>
              <li className="rounded-sm px-3  py-1  pl-6 cursor-pointer">Logs</li>
            </a>        
        </NavLink>
      </ul>
    </div>
