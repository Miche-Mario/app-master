...
const styles = StyleSheet.create({
    ...
    line2: { backgroundColor: "white", padding: 4, color: "black", marginHorizontal: 30, flexDirection: "row", alignItems: 'center' }
});
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.sectionFirst}>
                    <View style={{ width: 240 }}>
                        ...
                        <Text style={{ fontSize: 9, marginTop: 2 }}>Tel. +233 302 434 339</Text>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row' }}>
                            ...
                            <View style={{ marginLeft: 20, display: "flex", flexDirection: 'column' }}>
                                ...
                                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', backgroundColor: "#AED8E6", paddingTop: 5, paddingBottom: 5, width: 115 }}>
                                    <Text>{dis !== 0 ? currency.lecurrency + " "+ dis : "0,00"}</Text>
                                </View>
