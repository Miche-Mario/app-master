    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.sectionFirst}>
          <View style={{ width: 240 }}>
            ...
            <Text style={{ fontSize: 9, marginTop: 2 }}>
              45 Manye Adorkor Avenue New Achimota{" "}
            </Text>
            <Text style={{ fontSize: 9, marginTop: 2 }}>
              P.0 box MS 474 Mile 7 New-Achimota Accra
            </Text>
            <Text style={{ fontSize: 9, marginTop: 2 }}>
              Tel. +233 302 434 339
            </Text>
            <Text style={{ fontSize: 9, marginTop: 2 }}>
              Email: jodan@eaglevisionworld.com
            </Text>
          </View>
          <View style={{ marginTop: 5, flexDirection: "row", marginLeft: 130 }}>
            <View style={{ flexDirection: "column", alignItems: "flex-end" }}>
              <Text style={{ fontSize: 8, color: "green", marginTop: 2 }}>
                Invoice No :{" "}
              </Text>
              <Text style={{ fontSize: 8, color: "green", marginTop: 2 }}>
                Date :{" "}
        ...
        <View style={{ marginTop: 20, marginHorizontal: 30 }}>
          <Text style={{ marginTop: 3, fontSize: "10", fontWeight: "800" }}>
            {surnameg} {forenamesg}
          </Text>
        ...
        <View style={{ marginTop: 10 }}>
          ...
          >
            ...
            <View style={{ width: 150 }}>
              <Text style={{ fontSize: 9, paddingLeft: 4 }}></Text>
            </View>
          </View>
          <View
            style={{
            ...
            <View style={{ width: 430 }}>
              <View style={{ paddingLeft: 5, flexDirection: "row" }}>
                ...
                <Text style={{ marginLeft: 5, fontSize: 8 }}>
                  {courseList.length >= 1 && courseList[0].laduration} Months of
                  English
                  {courseList.length > 1 && " + " + courseList[1].lecoursename}
                </Text>
              </View>
            </View>
            <View style={{ width: 150 }}>
          ...
          >
            <View style={{ width: 430, paddingTop: 3 }}>
              <View style={{ paddingLeft: 5, flexDirection: "row" }}>
                <Text style={{ marginRight: 2, fontSize: 9 }}>
                  ACCOMMODATION:
                </Text>
                <Text style={{ marginLeft: 5, fontSize: 8 }}>
                  {accoList.map((objet) => objet.accodescription).join(" + ")}
                </Text>
              </View>
            </View>
            <View style={{ width: 150 }}></View>
        ...
        <View style={{ marginTop: 8 }}>
          ...
          {registrationList !== 0 &&
            registrationList.map((regist, index) => (
              <View
                style={[
                  index % 2 === 0 && styles.line1,
                  index % 2 !== 0 && styles.line2,
                ]}
              >
                <View style={{ width: 150 }}>
                ...
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9, fontWeight: "extralight" }}>
                    {regist.lecurrency} {separator(regist.regir)}
                  </Text>
                </View>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9 }}>
          ...
          {courseList !== 0 &&
            courseList.map((courses, index) => (
              ...
              >
                ...
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9, fontWeight: "extralight" }}>
                    {courses.lecurrency} {separator(courses.price)}
                  </Text>
                </View>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9 }}>
          ...
          {purchaseList !== 0 &&
            purchaseList.map((item, index) => (
              <View style={styles.line1} key={index}>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9, paddingLeft: 5 }}>
                    {item.purchasetimes}
                  </Text>
                </View>
                <View style={{ width: 280 }}>
                ...
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9, fontWeight: "extralight" }}>
                    {item.lecurrency} {separator(item.purchaseprice)}
                  </Text>
                </View>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9 }}>
                    {item.lecurrency}{" "}
                    {separator(item.purchaseprice * item.purchasetimes)}{" "}
                  </Text>
                </View>
              </View>
            ))}
            ...
            otherFeeList.map((fee, index) => (
              ...
              >
                ...
                <View style={{ width: 280 }}>
                  <Text style={{ fontSize: 9 }}>
                    {" "}
                    {fee.otherfeedescription}
                  </Text>
                </View>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9, fontWeight: "extralight" }}>
                    {fee.lecurrency} {separator(fee.otherfeeprice)}
                  </Text>
                </View>
                <View style={{ width: 150 }}>
                  <Text style={{ fontSize: 9 }}>
        ...
        <View style={{ display: "flex", flexDirection: "row" }}>
          ...
          >
            ...
            <br />
            <Text style={{ margintTop: 2 }}>throug the bank,</Text>
            <br />
            <Text style={{ margintTop: 2 }}>Use the details below</Text>
            <br />
          </View>
          ...
          <View style={{ fontSize: 9, marginLeft: 203 }}>
            <View style={{ display: "flex", flexDirection: "row" }}>
              ...
              >
                ...
                >
                  <Text>
                    {currency.lecurrency} {separator(subtotal)}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  <Text>
                    {dis !== 0 ? currency.lecurrency + " " + dis : "0,00"}
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  <Text>
                    {currency.lecurrency} {separator(total)}
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View style={{ display: "flex", flexDirection: "row" }}>
            ...
            <View style={{ marginLeft: 20 }}>
              <Text style={{ fontSize: 10 }}>
                EAGLE VISION LANGUAGE INSTITUTE LTD
              </Text>
            </View>
          </View>
